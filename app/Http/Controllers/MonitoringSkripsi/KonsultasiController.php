...
class KonsultasiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('monitoring-skripsi.konsultasi.index',$data);
    }
    ...
    public function create()
    {
    	...
    	return view('monitoring-skripsi.konsultasi.create',$data);
    }
   ...
   public function edit($id)
    {
        ...
        return view('monitoring-skripsi.konsultasi.edit',$data);
    }
    ...
    public function editAction($id, Request $request)
    {
        ...
        $konsultasi->id_skripsi = $request->input('id_skripsi');
