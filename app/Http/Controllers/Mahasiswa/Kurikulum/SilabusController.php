...
class SilabusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('mahasiswa.kurikulum.silabus.index',$data);
    ...
    public function create()
    {
        ...
        return view('mahasiswa.kurikulum.silabus.create',$data);
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return Redirect::to('/mahasiswa/kurikulum/silabus');
   ...
   public function edit($id)
    {
        ...
        return view('mahasiswa.kurikulum.silabus.edit',$data);
    }
    ...
    public function pdf($id)
    {
        ...
        $pdf = PDF::loadView('mahasiswa.kurikulum.silabus.pdf-silabus', $data);
