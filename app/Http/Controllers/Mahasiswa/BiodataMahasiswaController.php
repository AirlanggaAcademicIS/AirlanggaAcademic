...
class BiodataMahasiswaController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        BiodataMahasiswa::create($request->input());
    ...
    public function delete($id)
    {
        ...
        $biodata_mhs = BiodataMahasiswa::find($id);
   ...
   public function edit($id)
    ...
    public function editAction($id, Request $request)
    {
        ...
        $biodata_mhs->nip_petugas = "08777777";
        $biodata_mhs->nim = $request->input('nim');
        ...
        $biodata_mhs->foto_mhs = $request->input('foto_mhs');
        $biodata_mhs->kartu_identitas = $request->input('kartu_identitas');
        $biodata_mhs->save();
