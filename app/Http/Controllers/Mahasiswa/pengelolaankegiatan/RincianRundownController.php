 ...
 public function createEditLPJ($id_kegiatan)
   ...
   public function editLPJ($id_rundown)
    ...
    public function editProposal($id_rundown)
    {
        ...
        // Menampilkan form edit dan menambahkan variabel $data ke tampilan tadi, agar nanti value di formnya bisa ke isi
        return view('mahasiswa.pengelolaan-kegiatan.rincian-rundown.tambahEdit',$data);
    }
    ...
    public function editActionProposal1($id_rundown, Request $request)
    {
        ...
        // Kembali ke halaman mahasiswa/biodata
        return Redirect::to('mahasiswa/pengelolaan-kegiatan/rincian-rundown/'.$rincianrundown->kegiatan_id);
    }
 public function editLPJ1($id_rundown)
    {
        ...
        // Menampilkan form edit dan menambahkan variabel $data ke tampilan tadi, agar nanti value di formnya bisa ke isi
        return view('mahasiswa.pengelolaan-kegiatan.rincian-rundown.tambahEditLPJ',$data);
    }
    ...
    public function editActionLPJ1($id_rundown, Request $request)
    {
        ...
        // Kembali ke halaman mahasiswa/biodata
        return Redirect::to('mahasiswa/pengelolaan-kegiatan/rincian-rundown/'.$rincianrundown->kegiatan_id.'/lpj');
    }
