...
class PublikasiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('mahasiswa.pengelolaan-kegiatan.publikasi.index',$data);
    }
    ...
    public function create()
    {
    	...
    	return view('mahasiswa.pengelolaan-kegiatan.publikasi.create',$data);
    }
   ...
   public function edit($id)
    {
        ...
        return view('mahasiswa.pengelolaan-kegiatan.publikasi.edit',$data);
    }
    ...
    public function editAction($id, Request $request)
    {
        ...
        // Kembali ke halaman mahasiswa/biodata
        return Redirect::to('mahasiswa/kegiatan/publikasi');
    }
