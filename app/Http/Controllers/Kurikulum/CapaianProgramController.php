...
class CapaianProgramController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Kurikulum.capaian-program.index',$data);
    }
    ...
    public function create()
    {
    	...
    	return view('kurikulum.capaian-program.create',$data);
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return Redirect::to('kurikulum/capaian-program');
    }
   ...
   public function edit($id)
    {
        ...
        return view('kurikulum.capaian-program.edit',$data);
    }
    ...
    public function editAction($id, Request $request)
    {
        ...
        $cp_program->id_prodi = $request->input('id_prodi');
