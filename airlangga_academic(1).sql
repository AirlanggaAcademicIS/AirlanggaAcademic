...
--
-- Host: localhost
-- Generation Time: May 10, 2017 at 06:27 PM
...
CREATE TABLE `biodata_mhs` (
  `id_bio` varchar(15) NOT NULL,
  `nip_petugas` varchar(15) NOT NULL,
...
INSERT INTO `biodata_mhs` (`id_bio`, `nip_petugas`, `nim_id`, `nama_mhs`, `email_mhs`, `jenis_kelamin`, `negara_asal`, `provinsi_asal`, `kota_asal`, `kota_tinggal`, `alamat_tinggal`, `ttl`, `angkatan`, `agama`, `kebangsaan`, `sma_asal`, `nama_ayah`, `nama_ibu`, `deskripsi_diri`, `motto`, `foto_mhs`, `kartu_identitas`, `created_at`, `updated_at`, `deleted_at`) VALUES
('', '12345', '081411631070', 'nama mhs', 'email@mhs.com', 'jenis kelamin', 'negara asal', 'provinsi asal', 'kota asal', 'kota tinggal ', 'alamat tinggal', 'surabaya, 7 juni 2015', '2014', 'agama', 'kebangsaan', 'sma asal', 'nama ayah', 'nama ibu', 'deskripsi diri', 'motto', 'url foto mhs', 'url ktm', '2017-05-07 09:22:12', NULL, NULL);
...
(0, 2, 1, 'KK9', 'deskripsi kk9', '2017-05-07 11:14:42', NULL, NULL),
...
CREATE TABLE `detail_anggota` (
  ...
  `kode_penelitian_id` varchar(15) NOT NULL,
...
INSERT INTO `detail_anggota` (`id_anggota`, `kode_penelitian_id`, `anggota`, `status`, `created_at`, `updated_at`, `is_verified`, `deleted_at`) VALUES
(1, 'abc123', 'nama anggota 1', 0, '2017-05-07 09:32:45', NULL, 0, NULL);
...
INSERT INTO `detail_penelitian` (`id_penelitian`, `kode_penelitian_id`, `abstract`, `background`, `objective`, `methods`, `results`, `is_verified`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'abc123', 'abstrak penelitian', 'latar belakang penelitian', 'tujuan penelitian', 'metode penelitian', 'hasil penelitian', 0, '2017-05-07 09:31:49', NULL, NULL);
...
INSERT INTO `dosen` (`nip`, `password`, `created_at`, `updated_at`, `deleted_at`) VALUES
('12345678910', 'dummy_password', '2017-05-07 08:58:51', NULL, NULL);
...
INSERT INTO `dosen_rapat` (`nip`, `notulen_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
('12345678910', 'kode1', '2017-05-07 10:37:15', NULL, NULL);
...
INSERT INTO `mahasiswa` (`nim`, `nlp_id`, `password`, `created_at`, `updated_at`, `deleted_at`) VALUES
('081411631070', '12345678910', 'password', '2017-05-07 09:16:12', NULL, NULL);
...
INSERT INTO `notulen_rapat` (`id_notulen`, `permohonan_ruang_id`, `nip_petugas_id`, `nip_id`, `nama_rapat`, `agenda_rapat`, `waktu_pelaksanaan`, `hasil_pembahasan`, `id_verifikasi`, `deskripsi_rapat`) VALUES
('kode1', 1, '12345', '12345678910', 'nama rapat', 'agenda rapat', '2017-05-07 10:36:29', 'hasil rapat', '0', 'deskripsi rapat');
...
CREATE TABLE `penelitian_mhs` (
  `kode_penelitian` varchar(15) NOT NULL,
  `nim_id` varchar(15) NOT NULL,
  `nip_petugas_id` varchar(50) NOT NULL,
...
INSERT INTO `penelitian_mhs` (`kode_penelitian`, `nim_id`, `nip_petugas_id`, `judul`, `peneliti`, `fakultas`, `tahun`, `halaman_naskah`, `sumber_dana`, `besar_dana`, `sk`, `publikasi`, `kategori_penelitian`, `is_verified`, `file_pen`, `created_at`, `updated_at`, `deleted_at`) VALUES
('abc123', '081411631070', '12345', 'judul penelitian', 'peneliti', 'fakultas', '2018', 'hal', 'sumber dana', 'besar dana', 'sk', 'publikasi', 'kategori penelitian', 0, 'url file penelitian', '2017-05-07 09:29:47', NULL, NULL);
...
INSERT INTO `petugas_tu` (`nip_petugas`, `nama_petugas`, `no_telp_petugas`, `email_petugas`, `password`, `created_at`, `updated_at`, `deleted_at`) VALUES
('12345', 'nama petugas', 'telp petugas', 'email@petugas.com', 'password', '2017-05-07 09:19:15', NULL, NULL);
...
INSERT INTO `prestasi` (`id_prestasi`, `nip_petugas_id`, `nim_id`, `kelompok_kegiatan`, `jenis_kegiatan`, `tingkat`, `prestasi`, `tahun_kegiatan`, `penyelenggara`, `file_prestasi`, `ps_is_verified`, `skor`, `created_at`, `updated_at`, `deleted_at`) VALUES
('', '12345', '081411631070', 'kelompok kegiatan prestasi', 'jenis kegiatan', 'tingkat', 'prestasi', '2015', 'penyelenggara', 'url file prestasi', 0, NULL, '2017-05-07 09:23:54', NULL, NULL);
...
INSERT INTO `rincian_dana` (`id_rdana`, `kegiatan_id`, `nama`, `kuantitas`, `harga`, `kategori`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, 'nama rincian barang', 3, 1500, 3, '2017-05-07 10:53:58', NULL, NULL);
...
INSERT INTO `rincian_rundown` (`id_rundown`, `kegiatan_id`, `waktu`, `nama`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 1, '2017-05-04 00:00:00', 'nama kegiatan rundown', '2017-05-07 10:52:53', NULL, NULL);
...
CREATE TABLE `skripsi` (
  ...
  `statusprop_id` int(11) NOT NULL,
  `statusskrip_id` int(11) NOT NULL,
  `Judul` varchar(100) NOT NULL,
...
INSERT INTO `skripsi` (`id_skripsi`, `NIM_id`, `kbk_id`, `statusprop_id`, `statusskrip_id`, `Judul`, `upload_berkas`, `nip_petugas_id`, `tgl_sidangpro`, `waktu_sidangpro`, `tempat_sidangpro`, `nilai_sidangpro`, `tgl_sidangskrip`, `waktu_sidangskrip`, `tempat_sidangskrip`, `tanggal_pengumpulan_proposal`, `tanggal_pengumpulan_skripsi`, `is_verified`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, '081411631070', 2, 1, 1, 'judul skripsi', 'url berkas', '12345', '2017-05-01', '03:00:00', 'tempat sidang proposal', 100, '2017-05-02', '01:00:00', 'tempat sidang skripsi', '2017-05-03', '2017-05-01', 1, '2017-05-07 09:38:38', NULL, NULL);
...
CREATE TABLE `surat_masuk` (
  `no_surat_masuk` varchar(16) NOT NULL,
  `nip_petugas_id` varchar(50) NOT NULL,
  `nama_lembaga` varchar(100) NOT NULL,
...
INSERT INTO `surat_masuk` (`no_surat_masuk`, `nip_petugas_id`, `nama_lembaga`, `judul_surat_masuk`, `nim_nip`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
('12/sb/srt', '12345', 'nama lembaga', 'judul surat masuk', '081411631050', 0, '2017-05-07 10:28:22', NULL, NULL);
...
(5, 'mahasiswa', 'Mahasiswa', 'mahasiswa', 'mahasiswa@email.com', '$2y$10$jOI14OJADWUUImOHnZztquz9BdO/2dFYiRPBhtyygc8DEmIbLNLNq', 'U5KAAq7Vy92o358bWcBNEgM3VKbUBkRQpAwnSrpbUrbSeuCjxFPBNQmhJpbT', '2017-05-10 03:40:14', '2017-05-10 03:40:14'),
...
ALTER TABLE `biodata_mhs`
  ...
  ADD CONSTRAINT `biodata_mhs_ibfk_2` FOREIGN KEY (`nip_petugas`) REFERENCES `petugas_tu` (`nip_petugas`);
...
--
ALTER TABLE `cp_prodi`
  ADD CONSTRAINT `cp_prodi_ibfk_1` FOREIGN KEY (`cpem_id`) REFERENCES `capaian_pembelajaran` (`id_cpem`),
...
--
ALTER TABLE `detail_anggota`
  ADD CONSTRAINT `detail_anggota_ibfk_1` FOREIGN KEY (`kode_penelitian_id`) REFERENCES `penelitian_mhs` (`kode_penelitian`);
...
--
ALTER TABLE `detail_penelitian`
  ADD CONSTRAINT `detail_penelitian_ibfk_1` FOREIGN KEY (`kode_penelitian_id`) REFERENCES `penelitian_mhs` (`kode_penelitian`);
...
--
ALTER TABLE `dosen_rapat`
  ADD CONSTRAINT `dosen_rapat_ibfk_1` FOREIGN KEY (`notulen_id`) REFERENCES `notulen_rapat` (`id_notulen`),
...
--
ALTER TABLE `mk_prodi`
  ADD CONSTRAINT `mk_prodi_ibfk_1` FOREIGN KEY (`prodi_id`) REFERENCES `prodi` (`id_prodi`),
  ADD CONSTRAINT `mk_prodi_ibfk_2` FOREIGN KEY (`mk_id`) REFERENCES `mata_kuliah` (`id_mk`);

--
-- Constraints for table `mk_softskill`
--
ALTER TABLE `mk_softskill`
  ADD CONSTRAINT `mk_softskill_ibfk_1` FOREIGN KEY (`mk_id`) REFERENCES `mata_kuliah` (`id_mk`),
  ADD CONSTRAINT `mk_softskill_ibfk_2` FOREIGN KEY (`softskill_id`) REFERENCES `atribut_softskill` (`id_softskill`);

--
-- Constraints for table `notulen_rapat`
--
ALTER TABLE `notulen_rapat`
  ADD CONSTRAINT `notulen_rapat_ibfk_1` FOREIGN KEY (`nip_petugas_id`) REFERENCES `petugas_tu` (`nip_petugas`),
  ADD CONSTRAINT `notulen_rapat_ibfk_2` FOREIGN KEY (`nip_id`) REFERENCES `dosen` (`nip`),
  ADD CONSTRAINT `notulen_rapat_ibfk_3` FOREIGN KEY (`permohonan_ruang_id`) REFERENCES `permohonan_ruang` (`id_permohonan_ruang`);
...
--
ALTER TABLE `penelitian_milik_dosen`
  ADD CONSTRAINT `penelitian_milik_dosen_ibfk_2` FOREIGN KEY (`penelitian_id`) REFERENCES `penelitian_dosen` (`penelitian_id`),
  ADD CONSTRAINT `penelitian_milik_dosen_ibfk_3` FOREIGN KEY (`nip`) REFERENCES `dosen` (`nip`);

--
-- Constraints for table `pengajuan_kegiatan`
--
ALTER TABLE `pengajuan_kegiatan`
  ADD CONSTRAINT `fk_kategori_dana` FOREIGN KEY (`sumber_id`) REFERENCES `kategori_dana` (`id_sumber`);

--
-- Constraints for table `pengmas_dosen`
--
ALTER TABLE `pengmas_dosen`
  ADD CONSTRAINT `pengmas_dosen_ibfk_2` FOREIGN KEY (`kegiatan_id`) REFERENCES `surat_tugas` (`surat_id`),
  ADD CONSTRAINT `pengmas_dosen_ibfk_3` FOREIGN KEY (`nip`) REFERENCES `dosen` (`nip`);

--
-- Constraints for table `permohonan_ruang`
--
ALTER TABLE `permohonan_ruang`
  ADD CONSTRAINT `permohonan_ruang_ibfk_1` FOREIGN KEY (`nip_petugas_id`) REFERENCES `petugas_tu` (`nip_petugas`);

--
-- Constraints for table `persentase_penilaian`
--
ALTER TABLE `persentase_penilaian`
  ADD CONSTRAINT `jenis_penilaian_idfk_2` FOREIGN KEY (`jenis_penilaian_id`) REFERENCES `jenis_penilaian` (`id_jenis_penilaian`),
  ADD CONSTRAINT `mk_ditawarkan_idfk_5` FOREIGN KEY (`mk_ditawarkan_id`) REFERENCES `mk_ditawarkan` (`id_mk_ditawarkan`);

--
-- Constraints for table `prestasi`
--
ALTER TABLE `prestasi`
  ADD CONSTRAINT `prestasi_ibfk_1` FOREIGN KEY (`nim_id`) REFERENCES `mahasiswa` (`nim`),
  ADD CONSTRAINT `prestasi_ibfk_2` FOREIGN KEY (`nip_petugas_id`) REFERENCES `petugas_tu` (`nip_petugas`);
...
ALTER TABLE `prodi`
  ...
  ADD CONSTRAINT `prodi_ibfk_2` FOREIGN KEY (`nip_id`) REFERENCES `dosen` (`nip`);

--
-- Constraints for table `rincian_dana`
--
ALTER TABLE `rincian_dana`
  ADD CONSTRAINT `fk_rdana_kegiatan` FOREIGN KEY (`kegiatan_id`) REFERENCES `pengajuan_kegiatan` (`id_kegiatan`);

--
-- Constraints for table `rincian_rundown`
--
ALTER TABLE `rincian_rundown`
  ADD CONSTRAINT `fk_rundown_kegiatan` FOREIGN KEY (`kegiatan_id`) REFERENCES `pengajuan_kegiatan` (`id_kegiatan`);
...
ALTER TABLE `skripsi`
  ...
  ADD CONSTRAINT `skripsi_ibfk_3` FOREIGN KEY (`kbk_id`) REFERENCES `kbk` (`id_kbk`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `skripsi_ibfk_4` FOREIGN KEY (`NIM_id`) REFERENCES `mahasiswa` (`nim`),
  ADD CONSTRAINT `skripsi_ibfk_5` FOREIGN KEY (`nip_petugas_id`) REFERENCES `petugas_tu` (`nip_petugas`);

--
-- Constraints for table `surat_keluar_dosen`
--
ALTER TABLE `surat_keluar_dosen`
  ADD CONSTRAINT `surat_keluar_dosen_ibfk_1` FOREIGN KEY (`nip_petugas_id`) REFERENCES `petugas_tu` (`nip_petugas`);

--
-- Constraints for table `surat_keluar_mhs`
--
ALTER TABLE `surat_keluar_mhs`
  ADD CONSTRAINT `surat_keluar_mhs_ibfk_1` FOREIGN KEY (`nip_petugas_id`) REFERENCES `petugas_tu` (`nip_petugas`);

--
-- Constraints for table `surat_masuk`
--
ALTER TABLE `surat_masuk`
  ADD CONSTRAINT `surat_masuk_ibfk_1` FOREIGN KEY (`nip_petugas_id`) REFERENCES `petugas_tu` (`nip_petugas`);

--
-- Constraints for table `surat_tugas_dosen`
--
ALTER TABLE `surat_tugas_dosen`
  ADD CONSTRAINT `surat_tugas_dosen_ibfk_2` FOREIGN KEY (`surat_id`) REFERENCES `surat_tugas` (`surat_id`),
  ADD CONSTRAINT `surat_tugas_dosen_ibfk_3` FOREIGN KEY (`nip`) REFERENCES `dosen` (`nip`);

--
-- Constraints for table `transaksi_peminjaman`
--
ALTER TABLE `transaksi_peminjaman`
  ADD CONSTRAINT `transaksi_peminjaman_ibfk_1` FOREIGN KEY (`asset_id`) REFERENCES `asset` (`id_asset`),
  ADD CONSTRAINT `transaksi_peminjaman_ibfk_2` FOREIGN KEY (`nip_petugas_id`) REFERENCES `petugas_tu` (`nip_petugas`);
