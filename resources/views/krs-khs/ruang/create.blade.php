...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			@endif
			<br>
			<form id="tambahRuang" method="post" action="{{url('/krs-khs/ruang/create')}}" enctype="multipart/form-data"  class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="kapasitas" name="kapasitas" placeholder="Masukkan Kapasitas" required>
					</div>
				</div>
