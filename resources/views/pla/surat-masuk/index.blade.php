  ...
  <tbody>
   @forelse($surat_masuk as $i => $bio) 
    <tr>
      ...
      <td width="15%" style="text-align:center">{{$bio->nip_petugas}}</td>
      ...
      <td width="20%" style="text-align:center" >
        <a onclick="return confirm('Anda yakin untuk menghapus surat ini?');" href="{{url('/pla/surat-masuk/'.$bio->id_surat_masuk.'/delete/')}}" class="btn btn-danger btn-xs">
        <i class="fa fa-trash-o"></i> Hapus</a>
        <a href="{{url('/pla/surat-masuk/'.$bio->id_surat_masuk.'/edit/')}}" class="btn btn-warning btn-xs">
