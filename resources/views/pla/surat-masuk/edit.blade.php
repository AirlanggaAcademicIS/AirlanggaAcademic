...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			@endif
			<br>
			<form id="suratmasuk" method="post" action="{{url('/pla/surat-masuk/'.$surat_masuk->id_surat_masuk.'/edit')}}" enctype="multipart/form-data"  class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="nip_petugas" name="nip_petugas" value="{{$surat_masuk->nip_petugas}}" placeholder="Masukkan NIP Petugas" required>
					</div>
				</div>
