...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			<form id="tambahCapaianProgram" method="post" action="{{url('/kurikulum/capaian-program/'.$cp_program->id.'/edit')}}" enctype="multipart/form-data"  class="form-horizontal">
				...
				<div class="form-group">
					<label for="id_prodi" class="col-sm-2 control-label">Id Prodi</label>
					<div class="col-md-7">
						<input type="text" class="form-control input-lg" id="id_prodi" name="id_prodi" placeholder="Masukkan ID prodi" value="{{$cp_program->id_prodi}}" required>
					</div>
				</div>
