...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			@endif
			<br>
			<form id="tambahKonferensi" method="post" action="{{url('/dosen/biodata-dosen/'.$dosen->nip.'/edit')}}" enctype="multipart/form-data"  class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="nip" name="nip" placeholder="Masukkan NIP Dosen" value="{{$dosen->nip}}" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="nama_ketua" name="nama_dosen" placeholder="Masukkan Nama Dosen" value="{{$dosen->nama_dosen}}" required>
					</div>
				</div>
				...
				<div class="form-group">
                  ...
                  <div class="col-md-8">                 
						<input type="text" class="form-control input-lg" id="bidang_penelitian" name="alamat_dosen" placeholder="Masukkan Alamat Dosen" rows="5" value="{{$dosen->alamat_dosen}}" required > 
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="datepicker" name="tanggal_lahir_dosen" placeholder="Masukkan Tanggal Penelitian" value="{{$dosen->tanggal_lahir_dosen}}" required>
					</div>
				</div>
