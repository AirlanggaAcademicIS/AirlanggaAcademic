...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			<form id="tambahRundown" method="post" action="{{url('dosen/pengelolaan-kegiatan/rincian-rundown/'.$index->id_kegiatan.'/createActionEditProposal')}}" enctype="multipart/form-data"  class="form-horizontal">
