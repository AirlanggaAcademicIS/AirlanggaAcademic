...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			@endif
			<br>
			<form id="tambahRundown" method="post" action="{{url('dosen/pengelolaan-kegiatan/rincian-rundown/'.$rincianrundown->id_rundown.'/editActionProposal')}}" enctype="multipart/form-data"  class="form-horizontal">
