  ...
  <tbody>
   @forelse($rincianrundown as $i => $rundown) 
    <tr>
      ...
      <td width="20%" style="text-align:center" > <a href="{{url('dosen/pengelolaan-kegiatan/rincian-rundown/'.$rundown->id_rundown.'/viewEditProposal')}}" type="button" class="btn btn-warning btn-xs"> <i class="fa fa-pencil-square-o"></i>Edit</a></td>
    </tr>
     @empty
        <tr>
