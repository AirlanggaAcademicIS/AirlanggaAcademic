...
<div style="margin-bottom: 10px">
  ...
  <a href="{{url('/dosen/dokumentasi/create')}}" type="button" class="btn btn-info btn-md" >
   ...
   @forelse($dokumentasi as $i => $dok) 
    <tr>
      ...
      <td width="20%" style="text-align:center" ><a onclick="return confirm('Anda yakin untuk menghapus gambar ini?');" href="{{url('/kegiatan/dokumentasi/'.$dok->id_dokumentasi.'/delete/')}}" class="btn btn-danger btn-xs">
        ...
        <a href="{{url('/dosen/dokumentasi/'.$dok->id_dokumentasi.'/edit/')}}" class="btn btn-warning btn-xs">
        <i class="fa fa-pencil-square-o"></i> Edit</a>
        <a href="{{url('/dosen/pengelolaan-kegiatan/detail-pengajuan/'.$dok->kegiatan_id.'')}}" class="btn btn-success btn-xs"> View Detail</a>
        <a href="{{url('dosen/pengelolaan-kegiatan/dokumentasi/download/'.$dok->kegiatan_id.'')}}" class="btn btn-success btn-xs"> pdf</a>
        </td>
    </tr>
     @empty
        <tr>
