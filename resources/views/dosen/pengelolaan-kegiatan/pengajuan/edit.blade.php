...
<div class="row">
  <div class="col-md-12">
    <div class="">
      ...
      @endif
      <br>
      <form id="tambahPengajuan" method="post" action="{{url('dosen/pengelolaan-kegiatan/pengajuan/'.$pengajuan->id_kegiatan.'/revisiAction')}}" enctype="multipart/form-data"  class="form-horizontal">
