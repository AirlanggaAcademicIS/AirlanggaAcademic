  ...
  <tbody>
   @forelse($pengmas as $i => $pengmas) 
    <tr>
      ...
      <td width="10%" style="text-align:center">{{$pengmas->status_pengmas}}</td>
      <td width="20%" style="text-align:center" ><a onclick="return confirm('Anda yakin untuk menghapus pengmas ini?');" href="{{url('/dosen/pengmas/'.$pengmas->id_kegiatan.'/delete/')}}" class="btn btn-danger btn-xs">
        <i class="fa fa-trash-o"></i> Hapus</a>
        <a href="{{url('/dosen/pengmas/'.$pengmas->id_kegiatan.'/edit/')}}" class="btn btn-warning btn-xs">
