...
<div class="col-md-6">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Input Kategori Capaian Pembelajaran</h3>
            </div>

            <!-- /.box-header -->
            <div class="box-body">
              <form method="post" action="{{url('dosen/kurikulum/kodecppem/create')}}" enctype="multipart/form-data"  class="">
              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <!-- text input -->
                <div class="form-group">
                  <label>Nama Kategori</label>
                  <input type="text" class="form-control" id="nama_cpem" name="nama_cpem" placeholder="" required=>
                </div>
        ...
        <div class="col-md-6">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Daftar Kategori Capaian Pembelajaran</h3>
            </div>    
            <!-- /.box-header -->
                ...
                <tbody>
                 @forelse($kode_cppem as $i => $kod) 
                  <tr>
                   ...
                   @empty
                      <tr>
                        <td colspan="6"><center>Belum ada Kategori</center></td>
                      </tr>
                  @endforelse
                </tbody>
