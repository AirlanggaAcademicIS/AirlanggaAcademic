...
<div class="panel panel-info">
      <div class="panel-heading">Hasil Sidang Proposal</div>
...
<thead>
      <tr>
        ...
        <th data-field="nilai_proposal">Nilai</th>
        <!-- <th></th> -->
    ...
    @for ($i = 0; $i < count($hasil_sidang_proposal); $i++)
                            <tr>
                                ...
                                <td>
                                    <div>{{ $hasil_sidang_proposal[$i]['tgl_sidangpro']}}</div>
                                </td>
                                <td>
                                    <div>{{ $hasil_sidang_proposal[$i]['waktu_sidangpro']}}</div>
                                </td>
                                <td>
                                    <div>{{ $hasil_sidang_proposal[$i]['ruang']}}</div>
                                </td>
                                <td>
