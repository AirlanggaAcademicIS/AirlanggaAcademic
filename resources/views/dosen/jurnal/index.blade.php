  ...
  <tbody>
   @forelse($jurnal as $i => $jurnal) 
    <tr>
      ...
      <td width="20%" style="text-align:center" ><a onclick="return confirm('Anda yakin untuk menghapus jurnal ini?');" href="{{url('/dosen/jurnal/'.$jurnal->id_jurnal.'/delete/')}}" class="btn btn-danger btn-xs">
        <i class="fa fa-trash-o"></i> Hapus</a>
        <a href="{{url('/dosen/jurnal/'.$jurnal->id_jurnal.'/edit/')}}" class="btn btn-warning btn-xs">
