  ...
  <tbody>
   @forelse($konferensi as $i => $kon) 
    <tr>
      ...
      <td width="20%" style="text-align:center" ><a onclick="return confirm('Anda yakin untuk menghapus konferensi ini?');" href="{{url('/dosen/konferensi/'.$kon->id_konferensi.'/delete/')}}" class="btn btn-danger btn-xs">
        <i class="fa fa-trash-o"></i> Hapus</a>
        <a href="{{url('/dosen/konferensi/'.$kon->id_konferensi.'/edit/')}}" class="btn btn-warning btn-xs">
