...
<div style="margin-bottom: 10px">
  ...
  <a href="{{url('/pengelolaan-kegiatan/pengajuan/create')}}" type="button" class="btn btn-info btn-md" >
  ...
  <tbody>
   @forelse($pengajuan as $i => $pen) 
    <tr>
      ...
      <td width="15%" style="text-align:center">{{$pen->latar_belakang}}</td>
      <td width="20%" style="text-align:center">{{$pen->tujuan_kegiatan}}</td>
      <td width="10%" style="text-align:center">{{$pen->mekanisme_kegiatan}}</td>
      <td width="10%" style="text-align:center">{{$pen->tanggal_pengajuan}}</td>
      <td width="10%" style="text-align:center">{{$pen->tempat_pengajuan}}</td>
