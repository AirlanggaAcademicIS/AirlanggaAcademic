...
@section('main-content')
 <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <h2>
                    <a href="{{url('/kegiatan/postpertama')}}">Study Excursion di Gameloft, Jogjakarta</a>
                </h2>
                <p class="lead">
            ...
            <a class="btn btn-primary" href="{{url('/kegiatan/postpertama')}}">Read More <i class="fa fa-angle-right"></i></a>
            </div>
                ...
                <a href="blog-post.html">
                    <img class="img-responsive img-hover" src="{{asset('img/aisf.png')}}" alt="">
                </a>
                <hr>
                ...
                <hr>
                <a href="blog-post.html">
                    <img class="img-responsive img-hover" src="{{asset('img/Lokakarya.png')}}" alt="">
                </a>
                <hr>
                ...
                <hr>
                <a href="blog-post.html">
                    <img class="img-responsive img-hover" src="{{asset('img/stubanHead.png')}}" alt="">
                </a>
                <hr>
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-default" disabled><i class="fa fa-arrow-left"></i> Older</button>
                <button type="submit" class="btn btn-default pull-right">Newer <i class="fa fa-arrow-right"></i></button>
            </div>
