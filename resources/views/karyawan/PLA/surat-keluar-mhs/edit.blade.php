	...
	<div class="col-md-12">
		<div class="">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input type="text" class="form-control input-lg" id="nama_lembaga" name="nama_lembaga" placeholder="Nama Lembaga"  value="{{$surat_keluar_mhs->nama_lembaga}}" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="alamat" name="alamat" placeholder="Masukkan Alamat" value="{{$surat_keluar_mhs->alamat}}" required>
					</div>
				</div>
