...
<div class="row">
  <div class="col-md-12">
    <div class="">
      ...
      @endif
      <br>
      <form id="editNotulensi" method="post" action="{{url('notulensi/'.$notulensi->id_notulen.'/edit/')}}" enctype="multipart/form-data"  class="form-horizontal">
 ...
 @foreach($notulensi2 as $a)
  ...
  <div class="form-group">
      <label class="control-label col-sm-2" for="waktu_pelaksanaan" >Tanggal Rapat :</label>
        <div class="col-sm-9">
        <input type="text" id="waktu_pelaksanaan" name="waktu_pelaksanaan" placeholder="dd-mm-yyyy"
        value="{{$notulensi->waktu_pelaksanaan}}" style="width: 100%; height: 16px; font-size: 16px; line-height: 18px; border: 1px solid #dddddd; padding: 17px;" required>
        </div>
    </div>
