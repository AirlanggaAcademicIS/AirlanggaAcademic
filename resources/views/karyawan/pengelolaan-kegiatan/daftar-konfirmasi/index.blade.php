...
<h2>Daftar Proposal Kegiatan</h2>
   ...
   @forelse($konfirmasiProposal as $i => $konfirmasi_kegiatan) 
    <tr>
      ...
      <td width="20%" style="text-align:center">
        <a href="{{url('/karyawan/pengelolaan-kegiatan/detail-pengajuan/'.$konfirmasi_kegiatan->id_kegiatan.'/daftar-konfirmasi/proposal')}}" class="btn btn-success btn-xs"> View Detail</a>
      </td>
    </tr>

     @empty
        <tr>
          <td colspan="6"><center>Belum ada proposal kegiatan yang dikonfirmasi</center></td>
        </tr>
