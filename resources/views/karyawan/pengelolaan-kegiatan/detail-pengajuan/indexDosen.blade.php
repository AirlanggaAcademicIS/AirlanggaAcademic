...
<div class="col-sm-offset-10 col-sm-2">
        <a href="{{url('karyawan/pengelolaan-kegiatan/dokumentasi/download/'.$konfirmasi_kegiatan->id_kegiatan.'/dosen')}}"  type="submit" class="btn btn-default">Download</a>
    </div>
    </div>
   <h4>Deskripsi Umum</h4>
  <form class="form-horizontal" action="{{url('karyawan/pengelolaan-kegiatan/konfirmasi-kegiatan/proposal')}}">
    <div class="form-group">
