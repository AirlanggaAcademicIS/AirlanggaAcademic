...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			@endif
			<br>
			<form id="tambahPermohonanRuang" method="post" action="{{url('/karyawan/PermohonanRuang/'.$PermohonanRuang->id_permohonan_ruang.'/edit')}}" enctype="multipart/form-data"  class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="nip_petugas_id" name="nip_petugas_id" placeholder="Masukkan NIP" value="{{$PermohonanRuang->nip_petugas_id}}" required>
					</div>
				</div>
