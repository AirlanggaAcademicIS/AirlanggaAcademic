  ...
  <tbody>
   @forelse($MonsiStatus as $i => $stat) 
    <tr>
      ...
      <td width="20%" style="text-align:center" ><a onclick="return confirm('Anda yakin untuk menghapus status ini?');" href="{{url('/karyawan/monitoring-skripsi/status/'.$stat->id.'/delete/')}}" class="btn btn-danger btn-xs">
