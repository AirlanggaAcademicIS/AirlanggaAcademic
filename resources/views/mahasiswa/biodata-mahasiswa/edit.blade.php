...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			@endif
			<br>
		<form id="tambahBiodataMahasiswa" method="post" action="{{url('/mahasiswa/biodata-mahasiswa/'.$biodatamahasiswa->id.'/edit')}}" enctype="multipart/form-data"  class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="nim" name="nim" placeholder="Masukkan NIM" value="{{$biodatamahasiswa->nim}}" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="foto_mhs" name="foto_mhs" placeholder="Masukkan Link Foto"  value="{{$biodatamahasiswa->foto_mhs}}" required>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" class="form-control input-lg" id="kartu_identitas" name="kartu_identitas" placeholder="Masukkan Link Kartu Identitas"  value="{{$biodatamahasiswa->kartu_identitas}}" required>
					</div>
				</div>
