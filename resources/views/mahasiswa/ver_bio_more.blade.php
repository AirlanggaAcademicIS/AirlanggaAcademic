      ...
      <div class="box box-default">
        ...
        <div class="box-header with-border">
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-default"><a href="{{url('/karyawan/ver-bio/')}}">Cancel</a></button>
                <button type="button" class="btn btn-default" default ><a href="{{url('/karyawan/ver-bio/')}}">Save</a></button> 
             </div>
                </div>
  </div>
