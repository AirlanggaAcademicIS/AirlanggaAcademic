...
<form role="form" id="tambah-silabus" method="post" action="{{url('/mahasiswa/kurikulum/silabus/edit/'.$matkul_silabus->id_mk)}}" enctype="multipart/form-data">
    <div class="box box-danger">
        ...
        <div class="box-body">
            ...
            <div class="box-footer clearfix">
                <a href="{{{('/mahasiswa/kurikulum/silabus')}}}" class="btn btn-info">Kembali</a>
                </button>
            </div>
