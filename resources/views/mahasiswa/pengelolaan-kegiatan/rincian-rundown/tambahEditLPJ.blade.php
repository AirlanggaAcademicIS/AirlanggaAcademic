...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			@endif
			<br>
			<form id="tambahRundown" method="post" action="{{url('mahasiswa/pengelolaan-kegiatan/rincian-rundown/'.$rincianrundown->id_rundown.'/editActionLPJ1')}}" enctype="multipart/form-data"  class="form-horizontal">
