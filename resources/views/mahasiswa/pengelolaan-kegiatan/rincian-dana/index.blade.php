 ...
 <a data-toggle="modal" data-target="#modalRincianDana{{$kegiatan1->id_kegiatan}}" class="btn btn-danger btn-xs">
  ...
  <div class="modal fade" id="modalRincianDana{{$kegiatan1->id_kegiatan}}" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
   <form id="rincianDanaTabel" method="post" action="{{url('mahasiswa/pengelolaan-kegiatan/rincian-dana/'.$kegiatan1->id_kegiatan.'/tambahDana')}}" enctype="multipart/form-data"  class="form-horizontal">
