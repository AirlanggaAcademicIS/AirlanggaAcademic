 ...
 <a data-toggle="modal" data-target="#modalStrukturPanitia{{$kegiatan->id_kegiatan}}" class="btn btn-danger btn-xs">
  ...
  <div class="modal fade" id="modalStrukturPanitia{{$kegiatan->id_kegiatan}}" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
   <form id="strukturPanitia" method="post" action="{{url('mahasiswa/pengelolaan-kegiatan/input-struktur-panitia/'.$kegiatan->id_kegiatan.'/tambahPanitiaEdit')}}" enctype="multipart/form-data"  class="form-horizontal">
...
<table id="struturPanitiaTabel" class="table table-striped table-bordered" cellspacing="0">
  ...
  <div class="modal fade" id="modalStrukturPanitiaEdit{{$kegiatan->id_kegiatan}}{{$pan->nim_id}}" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
   <form id="strukturPanitiaEdit" method="post" action="{{url('mahasiswa/pengelolaan-kegiatan/input-struktur-panitia/'.$kegiatan->id_kegiatan.'/tambahPanitiaEdit')}}" enctype="multipart/form-data"  class="form-horizontal">
                   <input type="hidden" name="_token" value="{{ csrf_token() }}">
...
<a href="{{url('mahasiswa/pengelolaan-kegiatan/rincian-rundown/'.$kegiatan->id_kegiatan.'/edit')}}" class="btn btn-success btn-xs"> Simpan</a>
@endforeach
