...
<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			...
			@endif
			<br>
			<form id="tambahBiodata" method="post" action="{{url('mahasiswa/pengelolaan-kegiatan/dokumentasi/'.$Status->id_kegiatan.'/editAction')}}" enctype="multipart/form-data"  class="form-horizontal">
