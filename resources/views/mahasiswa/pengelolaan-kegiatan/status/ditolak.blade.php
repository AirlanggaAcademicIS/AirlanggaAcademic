  ...
  <tbody>
   @forelse($Status as $i => $pen) 
    <tr>
      ...
      <a href="{{url('/mahasiswa/pengelolaan-kegiatan/pengajuan/'.$pen->id_kegiatan.'/revisi')}}" class="btn btn-danger btn-xs"> Revisi</a>
  ...
  <tbody>
   @forelse($StatusLPJ as $i => $pen) 
    <tr>
      ...
      <td width="20%" style="text-align:center">
      <a href="{{url('/mahasiswa/pengelolaan-kegiatan/dokumentasi/'.$pen->id_kegiatan.'/revisiLPJ')}}" class="btn btn-success btn-xs"> Revisi</a>
        <a href="{{url('/mahasiswa/pengelolaan-kegiatan/detail-pengajuan/'.$pen->id_kegiatan)}}" class="btn btn-success btn-xs"> View Detail</a>
        </td>
    </tr>
     @empty
