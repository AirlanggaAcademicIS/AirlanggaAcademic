   ...
   @forelse($prestasi as $i => $bio) 
    <tr>
      ...
      @endif
       ...
       @if (($bio->ps_is_verified)==0)
      <td width="20%" style="text-align:center" ><a onclick="return confirm('Anda yakin untuk menghapus data prestasi ini?');" href="{{url('/mahasiswa/prestasi/'.$bio->id.'/delete/')}}" class="btn btn-danger btn-xs">
        <i class="fa fa-trash-o"></i> Hapus</a>
        <a href="{{url('/mahasiswa/prestasi/'.$bio->id.'/edit/')}}" class="btn btn-warning btn-xs">
