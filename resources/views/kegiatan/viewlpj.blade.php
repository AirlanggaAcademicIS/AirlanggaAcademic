            ...
            <a class="btn btn-primary" href="{{url('/kegiatan/postpertama')}}">Read More <i class="fa fa-angle-right"></i></a>
                ...
                <ul class="col-md-6">
                    <li class="previous" style="margin-right : 150px;">
                        <a><button type="button" class=" btn btn-block btn-default" disabled>&larr; Older</button></a>
                    </li>
                </ul>
                <ul class="col-md-6">
                    ...
                    <li class="next" style="margin-left: 150px;">
                        <a href="#"><button type="button" class="btn btn-block btn-default">Newer &rarr;</button></a>
