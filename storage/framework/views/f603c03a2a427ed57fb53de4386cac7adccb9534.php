...
<table id="myTable" class="table table-striped table-bordered" cellspacing="0">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="20%" style="text-align:center"><?php echo e($ass->nip_petugas); ?></td>
      <td width="15%" style="text-align:center"><?php echo e($ass->serial_barcode); ?></td>
      <td width="20%" style="text-align:center"><?php echo e($ass->nama_asset); ?></td>
      ...
      <td width="10%" style="text-align:center"><?php echo e($ass->total_harga); ?></td>
       <td width="20%" style="text-align:center" ><a onclick="return confirm('Anda yakin untuk menghapus asset ini?');" href="<?php echo e(url('/inventaris/asset/'.$bio->id.'/delete/')); ?>" class="btn btn-danger btn-xs">
        <i class="fa fa-trash-o"></i> Hapus</a>
        <a href="<?php echo e(url('/inventaris/asset/'.$bio->id.'/edit/')); ?>" class="btn btn-warning btn-xs">
