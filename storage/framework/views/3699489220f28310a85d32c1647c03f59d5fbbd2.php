  ...
  <tbody>
   <?php $__empty_1 = true; $__currentLoopData = $laporan_pelaksanaan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $pen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> 
    <tr>
      ...
      <td width="15%" style="text-align:center" ><a onclick="return confirm('Anda yakin untuk menghapus laporan LPJ ini?');" href="<?php echo e(url('/pengelolaan-kegiatan/laporan_pelaksanaan/'.$pen->id.'/delete/')); ?>" class="btn btn-danger btn-xs">
