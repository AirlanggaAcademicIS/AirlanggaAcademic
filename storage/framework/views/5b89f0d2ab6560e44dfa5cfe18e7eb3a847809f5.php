...
<div style="margin-bottom: 10px">
  ...
  <a href="<?php echo e(url('/pengelolaan-kegiatan/rincian_dana/create')); ?>" type="button" class="btn btn-info btn-md" >
  ...
  <tbody>
   <?php $__empty_1 = true; $__currentLoopData = $rincian_dana; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $bio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?> 
    <tr>
      ...
      <td width="20%" style="text-align:center" ><a onclick="return confirm('Anda yakin untuk menghapus rincian ini?');" href="<?php echo e(url('/pengelolaan-kegiatan/rincian_dana/'.$bio->id.'/delete/')); ?>" class="btn btn-danger btn-xs">
        <i class="fa fa-trash-o"></i> Hapus</a>
        <a href="<?php echo e(url('/pengelolaan-kegiatan/rincian_dana/'.$bio->id.'/edit/')); ?>" class="btn btn-warning btn-xs">
