...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			<?php endif; ?>
			<br>
			<form id="tambahCapaianProgram" method="post" action="<?php echo e(url('/kurikulum/capaian-program/create')); ?>" enctype="multipart/form-data"  class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<input type="text" class="form-control input-lg" id="id_prodi" name="id_prodi" placeholder="Masukkan Id Prodi" required>
					</div>
				</div>
