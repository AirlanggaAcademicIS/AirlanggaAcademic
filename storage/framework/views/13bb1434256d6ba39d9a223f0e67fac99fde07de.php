...
3. Fandi Bram</textarea>
              ...
              <div class="box-footer">
              	<a href="<?php echo e(url('/karyawan/ver-pen/')); ?>"><button type="button" class="btn btn-default">Cancel</button></a>
                <a href="<?php echo e(url('/karyawan/ver-pen/')); ?>"><button type="button" class="btn btn-primary">Save</button></a>
              </div>
            </form>
          </div>
          <!-- /.box -->
