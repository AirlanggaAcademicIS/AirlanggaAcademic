...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			<?php endif; ?>
			<br>
			<form id="tambahSistemPembelajaran" method="post" action="<?php echo e(url('/kurikulum/sistem-pembelajaran/create')); ?>" enctype="multipart/form-data"  class="form-horizontal">
