 ...
 <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <a href="<?php echo e(url('dosen/jurnal/create')); ?>"><button type="button" class="btn btn-primary">Tambah jurnal</button></a>
              <div class="box-tools">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><a href="<?php echo e(url('dosen/jurnal/edit')); ?>"><button type="button" class="btn btn-info btn-xs pull">Edit</button>
                  </a>
