...
<div class="container">
        ...
        <div class="row">
            <div class="col-lg-8">
                <h1 class="page-header">Study Excursion di Gameloft, Jogjakarta
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="#">Study Excursion di Gameloft, Jogjakarta</a></li>
                </ol>
            </div>
            <div class="col-lg-4">
                <a class="btn btn-app">
        ...
        <div class="row">
            ...
            <div class="col-lg-8">
                ...
                <!-- Preview Image -->
                <img class="img-responsive" src="<?php echo e(asset('img/seHead.png')); ?>" alt="">

                <hr>

                <!-- Post Content -->
                <p class="lead" style="text-align:justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ducimus, vero, obcaecati, aut, error quam sapiente nemo saepe quibusdam sit excepturi nam quia corporis eligendi eos magni recusandae laborum minus inventore?</p>
                ...
                <div class="media">
                    <a class="pull-left" href="#">
                        <img class="media-object" src="<?php echo e(asset('img/profile.jpg')); ?>" alt="">
                    </a>
                    <div class="media-body">
                        ...
                        <div class="media">
                            <a class="pull-left" href="#">
                                <img class="media-object" src="<?php echo e(asset('img/profile2.jpg')); ?>" alt="">
                            </a>
                            <div class="media-body">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    Apakah anda yakin akan menghapus pos ini?
                  </div>
