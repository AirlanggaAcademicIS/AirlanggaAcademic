...
<div class="row">
	<div class="col-md-12">
		<div class="">
			...
			<?php endif; ?>
			<br>
			<form id="tambahRincianDana" method="post" action="<?php echo e(url('/pengelolaan-kegiatan/rincian-dana/create')); ?>" enctype="multipart/form-data"  class="form-horizontal">
