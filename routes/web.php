...
>>>>>>> fd2c0ba6a4c5dda7a4c564d19fba6eb3d277cebe
        // Menampilkan tabel
        Route::get('detailanggota','Mahasiswa\DetailAnggotaController@index');
...
// Menampilkan tabel
    ...
    Route::group(['prefix' => 'pengelolaan-kegiatan'], function() {
        // Menampilkan tabel
        Route::get('rincian_dana','PengelolaanKegiatan\RincianDanaController@index');
        // Menampilkan form tambah biodata
        Route::get('rincian_dana/create','PengelolaanKegiatan\RincianDanaController@create');
        // Menambahkan form yg di isi tadi ke tabel biodata
        Route::post('rincian_dana/create','PengelolaanKegiatan\RincianDanaController@createAction');
        // Menghapus biodata sesuai id yang dipilih
        Route::get('rincian_dana/{kode_rincian}/delete','PengelolaanKegiatan\RincianDanaController@delete');
        // Menampilkan form edit biodata dari id yg dipilih
        Route::get('rincian_dana/{kode_rincian}/edit','PengelolaanKegiatan\RincianDanaController@edit');
        // Mengupdate biodata dengan isi dari form
        Route::post('rincian_dana/{kode_rincian}/edit','PengelolaanKegiatan\RincianDanaController@editAction');
