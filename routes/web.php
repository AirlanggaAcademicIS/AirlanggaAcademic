...
>>>>>>> 2aa00583008e5b1bdd8e381e50b738c91f56a38d
    ...
    Route::group(['prefix' => 'dosen'], function() {
            // Menampilkan tabel
        Route::get('biodatadosen','Dosen\BiodataDosenController@index');
        // Menampilkan form tambah biodata
        Route::get('biodatadosen/create','Dosen\BiodataDosenController@create');
        // Menambahkan form yg di isi tadi ke tabel biodata
        Route::post('biodatadosen/create','Dosen\BiodataDosenController@createAction');
        // Menghapus biodata sesuai id yang dipilih
        Route::get('biodatadosen/{id}/delete','Dosen\BiodataDosenontroller@delete');
        // Menampilkan form edit biodata dari id yg e
        Route::get('biodatadosen/{id}/edit','Dosen\BiodataDosenController@edit');
        // Mengupdate biodata dengan isi dari form
        Route::post('biodatadosen/{id}/edit','Dosen\BiodataDosenController@editAction');
