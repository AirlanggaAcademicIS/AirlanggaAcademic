...
*/
   ...
   Route::group(['prefix' => 'pengelolaan-kegiatan'], function() {
        // Menampilkan tabel
        Route::get('rincian-rundown','Mahasiswa\pengelolaankegiatan\RincianRundownController@index');

        // Menampilkan form tambah biodata
        Route::get('rincian-rundown/create','Mahasiswa\pengelolaankegiatan\RincianRundownController@create');

        // Menambahkan form yg di isi tadi ke tabel biodata
        Route::post('rincian-rundown/create','Mahasiswa\pengelolaankegiatan\RincianRundownController@createAction');

        // Menghapus biodata sesuai id yang dipilih
        Route::get('rincian-rundown/{id_rundown}/delete','Mahasiswa\pengelolaankegiatan\RincianRundownController@delete');
...
Route::group(['prefix' => 'pengelolaan-kegiatan'], function() {
        ...
        Route::get('dosen/pengelolaan-kegiatan/rincian-rundown','Dosen\pengelolaankegiatan\RincianRundownController@index');

    
        Route::get('dosen/pengelolaan-kegiatan/rincian-rundown/create','Dosen\pengelolaankegiatan\RincianRundownController@create');

      
        Route::post('dosen/pengelolaan-kegiatan/rincian-rundown/create','Dosen\pengelolaankegiatan\RincianRundownController@createAction');

        Route::get('dosen/pengelolaan-kegiatan/rincian-rundown/{id_rundown}/delete','Dosen\pengelolaankegiatan\RincianRundownController@delete');

       
        Route::get('dosen/pengelolaan-kegiatan/rincian-rundown/{id}/edit','Dosen\pengelolaankegiatan\RincianRundownController@edit');

   
        Route::post('dosen/pengelolaan-kegiatan/rincian-rundown/{id}/edit','Dosen\pengelolaankegiatan\RincianRundownController@editAction');
      });
...
Route::group(['prefix' => 'pengelolaan-kegiatan'], function() {
        ...
        Route::get('karyawan/pengelolaan-kegiatan/rincian-rundown','Karyawan\pengelolaankegiatan\RincianRundownController@index');

       
        Route::get('karyawan/pengelolaan-kegiatan/rincian-rundown/create','Karyawan\pengelolaankegiatan\RincianRundownController@create');

        
        Route::post('karyawan/pengelolaan-kegiatan/rincian-rundown/create','Karyawan\pengelolaankegiatan\RincianRundownController@createAction');

        
        Route::get('karyawan/pengelolaan-kegiatan/rincian-rundown/{id_rundown}/delete','Karyawan\pengelolaankegiatan\RincianRundownController@delete');

     
        Route::get('karyawan/pengelolaan-kegiatan/rincian-rundown/{id_rundown}/edit','Karyawan\pengelolaankegiatan\RincianRundownController@edit');

    
        Route::post('karyawan/pengelolaan-kegiatan/rincian-rundown/{id_rundown}/edit','Karyawan\pengelolaankegiatan\RincianRundownController@editAction');
        });
        // Menampilkan form edit biodata dari id yg dipilih
        Route::get('karyawan/pengelolaan-kegiatan/dokumentasi/{id_dokumentasi}/edit','karyawan\pengelolaankegiatan\DokumentasiController@edit');
