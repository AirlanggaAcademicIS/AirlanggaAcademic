...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::group(['prefix' => 'karyawan'], function() {
	    Route::group(['prefix' => 'monitoring-skripsi'], function() {
	        ...
	        Route::get('manage-jadwal-sidang-skripsi','Karyawan\SkripsiController@view_manage_jadwal_sidang_skripsi');

	        Route::post('create-jadwal-sidang-skripsi','Karyawan\SkripsiController@create_jadwal_sidang_skripsi');

	        Route::get('manage-hasil-sidang-skripsi','Karyawan\SkripsiController@view_manage_hasil_sidang_skripsi');
